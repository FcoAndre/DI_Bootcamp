...
// let a = 2 + 2;                       // a variavel eh igual a 4

// switch (a) {                         // abre o processo de condição
//   case 3:                            // se a variavel for igual a 3
//     alert( 'Too small' );            // informação displayed se variavel igual a 3
//     break;                           // interrompe o processo de condição
//   case 4:                           
//     alert( 'Exactly!' );
//     break;
//   case 5:
//     alert( 'Too large' );
//     break;
//   default:                                      // qualquer condição diferente das superiores
//     alert( "I don't know such values" );        // informação displayed se condição atingida
// }


// EXERCISE 3 - Guess what will be the result before checking it
